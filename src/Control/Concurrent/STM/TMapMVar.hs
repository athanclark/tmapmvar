...
import Control.Concurrent.STM.TVar (TVar, newTVar, modifyTVar', readTVar, swapTMVar, putTMVar)
import Control.Concurrent.STM.TMVar (TMVar, readTMVar, tryReadTMVar, newEmptyTMVar, takeTMVar, tryTakeTMVar)
